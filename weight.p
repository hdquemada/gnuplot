...
set xrange [ 0.00000 : 25.0000 ] noreverse nowriteback
...
GNUTERM = "x11"
## Last datafile plotted: "hdqweight1.csv"
plot 'hdqweight1.csv' using 1:3:xtic(2) with linespoints linewidth 3 pointtype 7 pointsize 2
#    EOF
