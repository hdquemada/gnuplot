...
set xrange [ 2009.90 : 2018.10 ] noreverse writeback
...
GNUTERM = "x11"
## Last datafile plotted: "mc.dat"
plot 'mc.dat' using 1:2 with linespoints t 'World' ls 7 lw 3, 'mc.dat' using 1:3 with linespoints t 'Africa' ls 6 lw 3
#    EOF
